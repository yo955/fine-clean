          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h3 className="text-2xl font-almarai font-bold text-orange mb-4">
                لماذا فاين كلين هى خيارك الأفضل ؟
              </h3>
              <ul className="space-y-3 text-white font-almarai">
                <li className="flex items-center">
                  <span className="text-orange ml-2">✓</span>
                  فريق متخصص عمالة أسيوية مدربة بإشراف سودانيين نضمن لك نظافة عميقة جداً.
                </li>
                <li className="flex items-center">
                  <span className="text-orange ml-2">✓</span>
                  نستخدم معدات حديثة ومواد تنظيف أصلية  وآمنة وصديقة للبيئة.
                </li>
                <li className="flex items-center">
                  <span className="text-orange ml-2">✓</span>
                  دع الخبراء يعتنون بالتنظيف لتحقيق نتائج مبهرة.
                </li>
                <li className="flex items-center">
                  <span className="text-orange ml-2">✓</span>
                  إذا لم تنل النظافة إعجابك، فإن الخدمة تعتبر مجاناً.
                </li>
                <li className="flex items-center">
                  <span className="text-orange ml-2">✓</span>
